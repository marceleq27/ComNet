      ...
      <Wrapper>
        ...
        <div>
          ...
          <Statistic
            ...
            text="x 8.0"
          />
          <Statistic width={`${15}%`} background="linear-gradient(120deg,#999 50%,#555)" text="" />
        </div>
        <div>
          Zaangażowanie{' '}
          <Statistic
            ...
            text="x 4.0"
          />
          <Statistic width={`${25}%`} background="linear-gradient(120deg,#999 50%,#555)" text="" />
        </div>
      </Wrapper>
      <Wrapper>
        <h4>Nasza firma**</h4>
        <div>
          ...
          <Statistic
            ...
            text="x 2.5"
          />
          <Statistic width={`${40}%`} background="linear-gradient(120deg,#999 50%,#555)" text="" />
        </div>
        <div>
          Pozytywne opinie{' '}
          <Statistic
            ...
            text="x 2.0"
          />
          <Statistic width={`${50}%`} background="linear-gradient(120deg,#999 50%,#555)" text="" />
        </div>
      </Wrapper>
      <p>
